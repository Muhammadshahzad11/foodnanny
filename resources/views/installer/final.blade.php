...
@section('container')
    <ul class="installer-track">
        ...
        <li onclick="handleLinkForInstaller('{{ route('installer.database') }}')" class="done">
            <i class="lab-fill-database"></i>
        </li>
        <li class="active"><i class="lab-fill-final"></i></li>
    </ul>
    ...
    <div class="text-center">
        <a href="{{ route('installer.finalStore') }}" class="p-3 px-6 rounded-lg inline-flex items-center justify-center gap-1 bg-primary text-white">
