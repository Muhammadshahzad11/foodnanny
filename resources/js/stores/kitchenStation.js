...
export const useKitchenStationStore = defineStore('kitchenStation', {
    state: () => ({
        lists: [],
        page: {},
        pagination: [],
    ...
    actions: {
        fetch: function (payload = {}) {
            return new Promise((resolve, reject) => {
                let url = "admin/restaurant-setting/kitchen-station";
                if (payload) {
        ...
        save: function (payload) {
            return new Promise((resolve, reject) => {
                ...
                if (this.temp.isEditing) {
                    url = `admin/restaurant-setting/kitchen-station/update/${this.temp.temp_id}`;
                }
        ...
        destroy: function (payload) {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/restaurant-setting/kitchen-station/${payload.id}`).then((res) => {
                    this.fetch(payload.search).then().catch();
                    resolve(res);
                }).catch((err) => {
                    reject(err);
