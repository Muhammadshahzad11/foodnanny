...
export const useItemStore = defineStore('item', {
    ...
    actions: {
        ...
        save: function (payload) {
            return new Promise((resolve, reject) => {
                ...
                if (this.temp.isEditing) {
                    url = `/admin/item/${this.temp.temp_id}`;
                }
        ...
        saveTranslations: function (payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/item/translations/${payload.id}`, payload.form).then((res) => {
                    resolve(res);
                }).catch((err) => {
                    reject(err);
                });
        ...
        changeImage: function (payload) {
            return new Promise((resolve, reject) => {
                axios.post(`/admin/item/change-image/${payload.id}`, payload.form, {
                    headers: {
