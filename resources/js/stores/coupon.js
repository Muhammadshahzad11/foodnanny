...
export const useCouponStore = defineStore('coupon', {
    ...
    actions: {
        ...
        save: function (payload) {
            return new Promise((resolve, reject) => {
                ...
                if (this.temp.isEditing) {
                    url = `/admin/coupon/${this.temp.temp_id}`;
                }
        ...
        destroy: function (payload) {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/coupon/${payload.id}`).then((res) => {
                    this.fetch(payload.search).then().catch();
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        view: function (payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/coupon/show/${payload}`).then((res) => {
        ...
        saveTranslations: function (payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/coupon/translations/${payload.id}`, payload.form).then((res) => {
                    resolve(res);
                }).catch((err) => {
                    reject(err);
                });
