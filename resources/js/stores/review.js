...
export const useReviewStore = defineStore('review', {
    ...
    actions: {
        ...
        save: function (payload) {
            return new Promise((resolve, reject) => {
                ...
                if (this.temp.isEditing) {
                    url    = `/admin/review/${this.temp.temp_id}`;
                }
        ...
        view: function (payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/review/show/${payload}`).then((res) => {
        ...
        destroy: function (payload) {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/review/${payload.id}`).then((res) => {
                    this.fetch(payload.search).then().catch();
                    resolve(res);
                }).catch((err) => {
                    reject(err);
