    ...
    actions: {
        fetch: function (payload = {}) {
            return new Promise((resolve, reject) => {
                let url = "admin/system-setting/benefit";
                if (payload) {
        ...
        save: function (payload) {
            return new Promise((resolve, reject) => {
                ...
                if (this.temp.isEditing) {
                    url = `/admin/system-setting/benefit/update/${this.temp.temp_id}`;
                }
        ...
        destroy: function (payload) {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/system-setting/benefit/${payload.id}`).then((res) => {
                    this.fetch(payload.search).then().catch();
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        view: function (payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/system-setting/benefit/show/${payload}`).then((res) => {
        ...
        sort: function (payload) {
            return new Promise((resolve, reject) => {
                axios.post('/admin/system-setting/benefit/sort', payload.form).then(res => {
                    this.fetch(payload.search).then().catch();
                    this.temp.temp_id   = null;
                    this.temp.isEditing = false;
                    resolve(res);
