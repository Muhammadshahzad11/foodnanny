                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col-12">
                            ...
                            <small class="db-field-alert"
                                v-if="errors.label && props.switchLabel !== labelEnum.OTHER">{{ errors.label[0] }}</small>
                        </div>
...
export default {
    ...
    methods: {
        ...
        reset: function () {
            ...
            this.employeeAddressStore.reset().then().catch();
            this.errors = {};
        ...
        save: function () {
            try {
                const tempId = this.employeeAddressStore.temp.temp_id;
                this.loading.isActive = true;
                this.employeeAddressStore.save({
