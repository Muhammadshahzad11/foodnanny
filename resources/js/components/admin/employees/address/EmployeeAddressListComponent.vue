    ...
    <div class="db-card db-tab-div active">
        <div class="db-card-header border-none">
            ...
            <div class="db-card-filter">
                ...
                <EmployeeAddressCreateComponent :props="address" v-if="permissionChecker('employees_create')" />
            </div>
        </div>
            ...
            <table class="db-table stripe">
                <thead class="db-table-head">
                    <tr class="db-table-head-tr">
                        ...
                        <th v-if="permissionChecker('employees_edit') || permissionChecker('employees_delete')"
                ...
                <tbody class="db-table-body" v-if="addresses.length > 0">
                    <tr class="db-table-body-tr" v-for="address in addresses" :key="address">
                        ...
                        <td class="db-table-body-td"
                            v-if="permissionChecker('employees_edit') || permissionChecker('employees_delete')">
...
import { useEmployeeAddressStore } from "../../../../stores/employeeAddress.js";
import { useFrontendSettingStore } from "../../../../stores/frontendSetting.js";
import VueSimpleAlert from "vue3-simple-alert";

export default {
    name: "EmployeeAddressListComponent",
    components: {
        LoadingComponent,
    ...
    props: ["props"],
    setup() {
        const employeeAddressStore = useEmployeeAddressStore();
    ...
    computed: {
        ...
        addresses: function () {
            return this.employeeAddressStore.lists;
        },
        pagination: function () {
            return this.employeeAddressStore.pagination;
        },
        paginationPage: function () {
            return this.employeeAddressStore.page;
        }
    },
    methods: {
        permissionChecker(e) {
        ...
        list: function (page = 1) {
            ...
            this.employeeAddressStore.fetch({
                id: this.props,
        ...
        edit: function (address) {
            ...
            this.loading.isActive = true;
            this.employeeAddressStore.edit(address.id).then((res) => {
                this.loading.isActive = false;
        ...
        destroy: function (addressId) {
            return new VueSimpleAlert.confirm(
                ...
                try {
                    this.loading.isActive = true
                    this.employeeAddressStore.destroy({
                        id: this.props,
                        addressId: addressId,
                        search: this.address.search
                    }).then((res) => {
