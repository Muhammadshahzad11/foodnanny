            ...
            <div class="drawer-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label for="role_id" class="db-field-title required">{{$t("label.role")}}</label>
                            <vue-select class="db-field-control f-b-custom-select" id="role_id" v-bind:class="errors.role_id ? 'invalid' : ''" v-model="props.form.role_id" :options="roles" label-by="name" value-by="id" :closeOnSelect="true" :searchable="true" :clearOnClose="true" placeholder="--" search-placeholder="--" />
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                this.loading.isActive = true;
                this.employeeStore.save(this.props).then((res) => {
                    useCanvas().closeCanvas('sidebar');
                    this.loading.isActive = false;
