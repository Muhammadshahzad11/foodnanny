                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input type="radio" v-model="props.form.status" id="approved"
                                            :value="enums.offerStatusEnum.APPROVE" class="custom-radio-field">
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input type="radio" class="custom-radio-field" v-model="props.form.status"
                                            id="reject" :value="enums.offerStatusEnum.REJECT">
                                        <span class="custom-radio-span"></span>
                                    </div>
...
export default {
    name: "OfferRestaurantVerifyComponent",
    ...
    methods: {
        resetModal: function () {
            ...
            this.offerRestaurantStore.reset();
        ...
        verify: function () {
            try {
                ...
                const tempId = this.offerRestaurantStore.temp.temp_id;
                this.offerRestaurantStore.verifyRestaurant({
                    offerId: this.$props.props.id,
                    id: tempId,
                    ...
                    this.errors = {};
                    alertService.successFlip(1, this.$t("menu.offers"));
                }).catch((err) => {
                    this.loading.isActive = false;
