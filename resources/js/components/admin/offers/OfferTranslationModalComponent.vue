<template>
    ...
    <div id="offerTranslationModal" class="modal">
                    ...
                    <div class="form-row">
                        ...
                        <template v-if="props.selectedLanguage && props.form.translations[props.selectedLanguage]">
                            <div class="form-col-12">
                                ...
                                <p v-if="props.offer.title" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5">
                                    <i class="lab lab-line-language"></i> {{ props.offer.title }}
                                </p>
                            ...
                            <div class="form-col-12">
                                ...
                                <p v-if="props.offer.description" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5" v-html="props.offer.description"></p>
...
export default {
    name: "OfferTranslationModalComponent",
    ...
    methods: {
        close: function () {
            useModal().closeModal('offerTranslationModal');
        },
        save: function () {
            this.loading.isActive = true;
            this.offerStore.saveTranslations({ id: this.$props.props.id, form: this.$props.props.form }).then(res => {
                this.loading.isActive = false;
                useModal().closeModal('offerTranslationModal');
                alertService.success(res.data.message);
                this.offerStore.view(this.$props.props.id);
            }).catch(err => {
                this.loading.isActive = false;
