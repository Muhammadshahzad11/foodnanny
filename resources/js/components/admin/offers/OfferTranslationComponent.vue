<template>
    ...
    <OfferTranslationModalComponent :props="modalProps" />
</template>
...
import OfferTranslationModalComponent from "./OfferTranslationModalComponent.vue";

const KEYS = ["title", "description"];

export default {
    name: "OfferTranslationComponent",
    components: { LoadingComponent, OfferTranslationModalComponent },
    setup() {
        const offerStore = useOfferStore();
        const languageStore = useLanguageStore();
        return { offerStore, languageStore };
    },
    data() {
        return {
    ...
    methods: {
        ...
        initForm: function () {
            const existing = this.offer.translations || [];
            const translations = {};
