            ...
            <div class="table-filter-div" id="offer-filter">
                <form class="p-4 sm:p-5 mb-5" @submit.prevent="search">
                    <div class="row">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            <label for="searchAmount" class="db-field-title after:hidden">{{$t("label.discount")}}</label>
                ...
                <table class="db-table stripe" id="print">
                    ...
                    <tbody class="db-table-body" v-if="offers.length > 0">
                        <tr class="db-table-body-tr" v-for="offer in offers" :key="offer">
                            ...
                            <td class="db-table-body-td hidden-print" v-if="permissionChecker('offers_show') || permissionChecker('offers_edit') || permissionChecker('offers_delete')">
                                <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                    <SmIconViewComponent :link="'admin.offer.show'" :id="offer.id" v-if="permissionChecker('offers_show')" />
                                    <SmIconSidebarModalEditComponent @click="edit(offer)" v-if="permissionChecker('offers_edit')" />
                                    <SmIconDeleteComponent @click="destroy(offer.id)" v-if="permissionChecker('offers_delete')" />
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
export default {
    ...
    computed: {
        ...
        offers: function () {
            return this.offerStore.lists;
        },
        pagination: function () {
            return this.offerStore.pagination;
        },
        paginationPage: function () {
            return this.offerStore.page;
        }
    },
    methods: {
        permissionChecker(e) {
        ...
        list: function (page = 1) {
            ...
            this.offerStore.fetch(this.props.search).then((res) => {
        ...
        edit: function (offer) {
            ...
            this.loading.isActive = true;
            this.offerStore.edit(offer.id).then(() => {
                this.offerStore.view(offer.id).then((res) => {
                    const data            = res.data.data;
                    this.loading.isActive = false;
                    this.props.errors     = {};
                    this.props.startTime  = this.parseTime(data.start_time);
        ...
        destroy: function (id) {
            return new VueSimpleAlert.confirm(
                ...
                try {
                    this.loading.isActive = true;
                    this.offerStore.destroy({ id: id, search: this.props.search }).then((res) => {
                            this.loading.isActive = false;
        ...
        xls: function () {
            this.loading.isActive = true;
            this.offerStore.export(this.props.search).then((res) => {
                this.loading.isActive = false;
