            ...
            <div class="modal-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label for="price"
                                   class="db-field-title required">{{ $t("label.additional_price") }}</label>
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label for="item_attribute" class="db-field-title required">{{
                                    $t("label.attribute")
                                }}</label>
                        ...
                        <div class="form-col-12">
                            ...
                            <div :class="errors.caution ? 'invalid textarea-error-box-style' : ''"
                                ...
                                <quill-editor v-model:value="props.form.caution"
                                              v-bind:class="errors.caution ? 'invalid' : ''" id="caution"
...
import {useItemAttributeStore} from "../../../../stores/itemAttribute.js";
...
export default {
    ...
    props: ["props"],
    setup() {
        const itemAttributeStore = useItemAttributeStore();
    ...
    computed: {
        itemAttributes: function () {
            return this.itemAttributeStore.lists;
        }
    },
    mounted() {
        this.itemAttributeStore.fetch({
            paginate: 0,
            order_column: 'id',
            order_type: 'desc',
    ...
    methods: {
        ...
        save: function () {
            try {
                const tempId          = this.itemVariationStore.temp.temp_id;
                this.loading.isActive = true;
                this.itemVariationStore.save(this.props).then((res) => {
                    useModal().closeModal('modal');
