            ...
            <div class="drawer-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6" v-if="props.form.discount_type === enums.taxTypeEnum.PERCENTAGE">
...
export default {
    ...
    methods: {
        ...
        save: function () {
            try {
                const tempId = this.couponStore.temp.temp_id;
                this.loading.isActive = true;
                this.couponStore.save(this.props).then((res) => {
                        useCanvas().closeCanvas('sidebar');
                        this.loading.isActive = false;
                        alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.coupons"));
                        this.props.form = {
                            name: "",
                            description: "",
                            code: "",
