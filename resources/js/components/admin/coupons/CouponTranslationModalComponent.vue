<template>
    ...
    <div id="couponTranslationModal" class="modal">
                    ...
                    <div class="form-row">
                        ...
                        <template v-if="props.selectedLanguage && props.form.translations[props.selectedLanguage]">
                            <div class="form-col-12">
                                ...
                                <p v-if="props.coupon.name" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5">
                                    <i class="lab lab-line-language"></i> {{ props.coupon.name }}
                                </p>
                            ...
                            <div class="form-col-12">
                                ...
                                <p v-if="props.coupon.description" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5" v-html="props.coupon.description"></p>
...
export default {
    name: "CouponTranslationModalComponent",
    ...
    methods: {
        close: function () {
            useModal().closeModal('couponTranslationModal');
        },
        save: function () {
            this.loading.isActive = true;
            this.couponStore.saveTranslations({ id: this.$props.props.id, form: this.$props.props.form }).then(res => {
                this.loading.isActive = false;
                useModal().closeModal('couponTranslationModal');
                alertService.success(res.data.message);
                this.couponStore.view(this.$props.props.id);
            }).catch(err => {
                this.loading.isActive = false;
