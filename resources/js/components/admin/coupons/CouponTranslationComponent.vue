<template>
    ...
    <CouponTranslationModalComponent :props="modalProps" />
</template>
...
import CouponTranslationModalComponent from "./CouponTranslationModalComponent.vue";

const KEYS = ["name", "description"];

export default {
    name: "CouponTranslationComponent",
    components: { LoadingComponent, CouponTranslationModalComponent },
    setup() {
        const couponStore = useCouponStore();
        const languageStore = useLanguageStore();
        return { couponStore, languageStore };
    },
    data() {
        return {
    ...
    methods: {
        ...
        initForm: function () {
            const existing = this.coupon.translations || [];
            const translations = {};
