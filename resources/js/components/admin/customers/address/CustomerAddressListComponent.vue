    ...
    <div class="db-card db-tab-div active">
        <div class="db-card-header border-none">
            ...
            <div class="db-card-filter">
                ...
                <CustomerAddressCreateComponent :props="address" v-if="permissionChecker('customers_create')" />
            </div>
        </div>
            ...
            <table class="db-table stripe">
                <thead class="db-table-head">
                    <tr class="db-table-head-tr">
                        ...
                        <th v-if="permissionChecker('customers_edit') || permissionChecker('customers_delete')"
                ...
                <tbody class="db-table-body" v-if="addresses.length > 0">
                    <tr class="db-table-body-tr" v-for="address in addresses" :key="address">
                        ...
                        <td class="db-table-body-td"
                            v-if="permissionChecker('customers_edit') || permissionChecker('customers_delete')">
                            <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                ...
                                <SmIconDeleteComponent @click="destroy(address.id)"
                                    v-if="permissionChecker('customers_delete')" />
                            </div>
                        </td>
                    </tr>
                </tbody>
...
export default {
    name: "CustomerAddressListComponent",
    components: {
        LoadingComponent,
    ...
    computed: {
        ...
        addresses: function () {
            return this.customerAddressStore.lists;
        },
        pagination: function () {
            return this.customerAddressStore.pagination;
        },
        paginationPage: function () {
            return this.customerAddressStore.page;
        },
    },
    methods: {
        permissionChecker(e) {
        ...
        list: function (page = 1) {
            ...
            this.customerAddressStore.fetch({
                id: this.props,
        ...
        edit: function (address) {
            ...
            this.loading.isActive = true;
            this.customerAddressStore.edit(address.id).then((res) => {
                this.loading.isActive = false;
        ...
        destroy: function (addressId) {
            return new VueSimpleAlert.confirm(
                ...
                "warning",
                {
                    ...
                    try {
                        this.loading.isActive = true;
                        this.customerAddressStore.destroy({
                            id: this.props,
                            addressId: addressId,
                            search: this.address.search,
                        })
