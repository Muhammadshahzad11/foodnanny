                            ...
                            <td class="db-table-body-td" colspan="5">
                                <div class="p-4">
                                    <img class="m-auto not-found max-w-[300px]" :src="setting.data_not_found"
                                        alt="Not Found">
                                    <span class="block mt-3 text-center text-lg">{{ $t('message.no_data_found')
                                    }}</span>
                                </div>
                            </td>
                        </tr>
...
export default {
    ...
    computed: {
        ...
        customers: function () {
            return this.customerStore.lists;
        },
        pagination: function () {
            return this.customerStore.pagination;
        },
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.customerStore.fetch(this.props.search).then((res) => {
        ...
        edit: function (customer) {
            this.loading.isActive = true;
            this.customerStore.edit(customer.id).then((res) => {
                this.loading.isActive = false;
                this.props.errors = {};
                this.props.form = {
                    name        : customer.name,
                ...
                this.countryCodeStore.fetchFind({country_code: customer.country_code}).then(res => {
        ...
        xls: function () {
            this.loading.isActive = true;
            this.customerStore.export(this.props.search).then((res) => {
                this.loading.isActive = false;
