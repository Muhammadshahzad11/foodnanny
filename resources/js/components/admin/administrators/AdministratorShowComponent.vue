<template>
    ...
    <div class="col-12">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-12 sm:col-6 !py-1.5">
                            <div class="db-list-item p-0">
                                ...
                                <span v-if="administrator.phone" class="db-list-item-text w-full sm:w-1/2">{{
        ...
        <div id="address" class="tab-content">
            <AdministratorAddressListComponent :props="$route.params.id" />
        </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <p class="text-sm leading-6 font-rubik capitalize text-heading">
                                            {{ $t("label.total") }}: <span class="font-medium">{{
                                                order.total_currency_price }}</span></p>
                                        <router-link
...
import AdministratorAddressListComponent from "./address/AdministratorAddressListComponent.vue";
...
export default {
    ...
    components: {
        LoadingComponent,
        AdministratorAddressListComponent,
        PaginationSMBox,
        PaginationBox,
    ...
    computed: {
        ...
        administrator: function () {
            return this.administratorStore.show;
        },
        myOrders: function () {
            return this.administratorStore.myOrders;
        },
        orderPagination: function () {
            return this.administratorStore.orderPagination;
        },
        orderPage: function () {
            return this.administratorStore.orderPage;
        }
    },
    mounted() {
        this.loading.isActive = true;
        this.administratorStore.view(this.$route.params.id).then((res) => {
    ...
    methods: {
        ...
        orderLists: function (page = 1) {
            ...
            this.administratorStore.callMyOrders({
        ...
        saveImage: function () {
            if (this.$refs.imageProperty.files[0]) {
                try {
                    ...
                    this.administratorStore.changeImage({
                        id: this.$route.params.id,
                        form: formData,
                    }).then((res) => {
        ...
        changePassword: function () {
            try {
                ...
                this.loading.isActive = true;
                this.administratorStore.changePassword({
