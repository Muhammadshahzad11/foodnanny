            ...
            <div class="db-card">
                <div class="db-card-header border-none">
                    ...
                    <nav class="flex flex-wrap gap-2 mobile:justify-center">
                        ...
                        <FilterComponent @click.prevent="handleSlide('transaction')" />
                ...
                <div class="table-filter-div" id="transaction">
...
export default {
    ...
    computed: {
        ...
        transactions: function () {
            return this.transactionStore.lists;
        },
        pagination: function () {
            return this.transactionStore.pagination;
        },
        paginationPage: function () {
            return this.transactionStore.page;
        }
    },
    methods: {
        search: function () {
        ...
        list: function (page = 1) {
            ...
            this.transactionStore.fetch(this.props.search).then(res => {
        ...
        xls: function () {
            this.loading.isActive = true;
            this.transactionStore.export(this.props.search).then((res) => {
                this.loading.isActive = false;
