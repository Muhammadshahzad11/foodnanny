            ...
            <div class="modal-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12  sm:form-col-6">
                            <label for="image" class="db-field-title"> {{ $t("label.image") }} (1:1) </label>
                            ...
                            <div class="db-field-radio-group">
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.displayModeEnum.LTR" v-model="props.form.display_mode" id="ltr" type="radio" class="custom-radio-field"/>
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.displayModeEnum.RTL" v-model="props.form.display_mode" type="radio" id="rtl" class="custom-radio-field"/>
                                        <span class="custom-radio-span"></span>
                                    </div>
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                const tempId          = this.languageStore.temp.temp_id;
                this.loading.isActive = true;
                this.languageStore.save({form: fd, search: this.props.search}).then((res) => {
                    useModal().closeModal('modal');
                    this.loading.isActive = false;
                    alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.languages"));
                    this.props.form                = {
                        title       : "",
                        description : "",
                        display_mode: displayModeEnum.LTR,
