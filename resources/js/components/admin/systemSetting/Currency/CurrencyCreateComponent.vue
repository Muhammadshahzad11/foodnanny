            ...
            <div class="modal-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label for="symbol" class="db-field-title required">{{ $t("label.symbol") }}</label>
                            <input v-model="props.form.symbol" v-bind:class="errors.symbol ? 'invalid' : ''" type="text" id="symbol" class="db-field-control" />
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.code" v-bind:class="errors.code ? 'invalid' : ''" type="text" id="code" class="db-field-control" />
                            ...
                            <div class="db-field-radio-group">
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.askEnum.YES" v-model="props.form.is_cryptocurrency" id="yes" type="radio" class="custom-radio-field" />
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.askEnum.NO" v-model="props.form.is_cryptocurrency" type="radio" id="no" class="custom-radio-field" />
                                        <span class="custom-radio-span"></span>
                                    </div>
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label for="exchange_rate" class="db-field-title">{{ $t("label.exchange_rate") }}</label>
                            <input v-on:keypress="floatNumber($event)" v-model="props.form.exchange_rate" v-bind:class="errors.exchange_rate ? 'invalid' : ''" type="text" id="exchange_rate" class="db-field-control" />
                            <small class="db-field-alert" v-if="errors.exchange_rate">{{ errors.exchange_rate[0] }}</small>
                        </div>
...
export default {
    ...
    methods: {
        ...
        save: function () {
            try {
                const tempId = this.currencyStore.temp.temp_id;
                this.loading.isActive = true;
                this.currencyStore.save(this.props).then((res) => {
                    useModal().closeModal('modal');
                    this.loading.isActive = false;
                    alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.currencies"));
                    this.props.form = {
                        name: "",
                        symbol: "",
                        code: "",
