...
export default {
    ...
    methods: {
        reset: function () {
            ...
            this.analyticSectionStore.reset();
            this.errors = {};
        ...
        save: function () {
            try {
                const tempId = this.analyticSectionStore.temp.temp_id;
                this.loading.isActive = true;
                this.analyticSectionStore.save(this.props).then((res) => {
                    useModal().closeModal('modal');
