    ...
    <div id="modal" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">{{ $t("menu.cuisines") }}</h3>
            ...
            <div class="modal-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12  sm:form-col-6">
                            <label for="image" class="db-field-title required"> {{ $t("label.image") }} (232px, 192px) </label>
...
export default {
    name: "CuisineCreateComponent",
    components: {LoadingComponent, SmModalCreateComponent, quillEditor},
    props: ["props"],
    setup() {
    ...
    data() {
        return {
            ...
            addButton: {
                title: this.$t("button.add_cuisine")
            },
            enums: {
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                const tempId          = this.cuisineStore.temp.temp_id;
                this.loading.isActive = true;
                this.cuisineStore.save({
                    form: fd,
                    search: this.props.search
                }).then((res) => {
                    useModal().closeModal('modal');
                    this.loading.isActive = false;
                    alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.cuisines"));
                    this.props.form = {
                        name: "",
                        description: "",
                        status: statusEnum.ACTIVE,
