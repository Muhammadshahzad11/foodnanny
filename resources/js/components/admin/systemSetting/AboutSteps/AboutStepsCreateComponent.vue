    ...
    <div id="modal" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">{{ $t("menu.about_steps") }}</h3>
                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.title" type="text" id="title"  v-bind:class="errors.title ? 'invalid' : ''"  class="db-field-control" />
                        ...
                        <div class="form-col-12 sm:form-col-12">
                            <label for="image" class="db-field-title required">{{ $t('label.image') }} (1:1)</label>
                        ...
                        <div class="form-col-12">
                            ...
                            <textarea v-model="props.form.description" v-bind:class="errors.description ? 'invalid' : ''" id="description" class="db-field-control"></textarea>
...
export default {
    name: "AboutStepsCreateComponent",
    ...
    data() {
        return {
            ...
            addButton: {
                title: this.$t("button.add_about_steps")
            },
            enums: {
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                const tempId = this.aboutStepStore.temp.temp_id;
                this.loading.isActive = true;
                this.aboutStepStore.save({ form: fd, search: this.props.search }).then((res) => {
                    useModal().closeModal('modal');
                    this.loading.isActive = false;
                    alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.about_steps"));
                    this.props.form = {
                        title      : "",
                        description: "",
                        status     : statusEnum.ACTIVE
