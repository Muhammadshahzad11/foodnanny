                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <div class="db-field-radio-group">
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.statusEnum.INACTIVE" v-model="props.form.status"  id="inactive" type="radio" class="custom-radio-field">
                                        <span class="custom-radio-span"></span>
                                    </div>
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                const tempId = this.benefitStore.temp.temp_id;
                this.loading.isActive = true;
                this.benefitStore.save({form: fd, search: this.props.search}).then((res) => {
                    useModal().closeModal('modal');
                    this.loading.isActive = false;
                    alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.benefits"));
                    this.props.form = {
                        title      : "",
                        description: "",
                        status     : statusEnum.ACTIVE
