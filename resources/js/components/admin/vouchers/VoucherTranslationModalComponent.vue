<template>
    ...
    <div id="voucherTranslationModal" class="modal">
                    ...
                    <div class="form-row">
                        ...
                        <template v-if="props.selectedLanguage && props.form.translations[props.selectedLanguage]">
                            <div class="form-col-12">
                                ...
                                <p v-if="props.voucher.name" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5">
                                    <i class="lab lab-line-language"></i> {{ props.voucher.name }}
                                </p>
                            ...
                            <div class="form-col-12">
                                ...
                                <p v-if="props.voucher.description" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5" v-html="props.voucher.description"></p>
...
export default {
    name: "VoucherTranslationModalComponent",
    ...
    methods: {
        close: function () {
            useModal().closeModal('voucherTranslationModal');
        },
        save: function () {
            this.loading.isActive = true;
            this.voucherStore.saveTranslations({ id: this.$props.props.id, form: this.$props.props.form }).then(res => {
                this.loading.isActive = false;
                useModal().closeModal('voucherTranslationModal');
                alertService.success(res.data.message);
                this.voucherStore.view(this.$props.props.id);
            }).catch(err => {
                this.loading.isActive = false;
