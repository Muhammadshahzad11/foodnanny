<template>
    ...
    <VoucherTranslationModalComponent :props="modalProps" />
</template>
...
import VoucherTranslationModalComponent from "./VoucherTranslationModalComponent.vue";

const KEYS = ["name", "description"];

export default {
    name: "VoucherTranslationComponent",
    components: { LoadingComponent, VoucherTranslationModalComponent },
    setup() {
        const voucherStore = useVoucherStore();
        const languageStore = useLanguageStore();
        return { voucherStore, languageStore };
    },
    data() {
        return {
    ...
    methods: {
        ...
        initForm: function () {
            const existing = this.voucher.translations || [];
            const translations = {};
