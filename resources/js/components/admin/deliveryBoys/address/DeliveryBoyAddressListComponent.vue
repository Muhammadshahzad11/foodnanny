    ...
    <div class="db-card db-tab-div active">
        <div class="db-card-header border-none">
            ...
            <div class="db-card-filter">
                ...
                <DeliveryBoyAddressCreateComponent :props="address" v-if="permissionChecker('delivery-boys_create')" />
            </div>
        </div>
            ...
            <table class="db-table stripe">
                <thead class="db-table-head">
                    <tr class="db-table-head-tr">
                        ...
                        <th v-if="permissionChecker('delivery-boys_edit') || permissionChecker('delivery-boys_delete')"
                ...
                <tbody class="db-table-body" v-if="addresses.length > 0">
                    <tr class="db-table-body-tr" v-for="address in addresses" :key="address">
                        ...
                        <td class="db-table-body-td"
                            v-if="permissionChecker('delivery-boys_edit') || permissionChecker('delivery-boys_delete')">
...
import { useDeliveryBoyAddressStore } from "../../../../stores/deliveryBoyAddress.js"
import { useFrontendSettingStore } from "../../../../stores/frontendSetting.js"
import VueSimpleAlert from "vue3-simple-alert";

export default {
    name: "DeliveryBoyAddressListComponent",
    components: {
        LoadingComponent,
    ...
    props: ["props"],
    setup() {
        const deliveryBoyAddressStore = useDeliveryBoyAddressStore();
        const frontendSettingStore = useFrontendSettingStore();
        return {
            deliveryBoyAddressStore,
    ...
    computed: {
        ...
        addresses: function () {
            return this.deliveryBoyAddressStore.lists;
        },
        pagination: function () {
            return this.deliveryBoyAddressStore.pagination;
        },
        paginationPage: function () {
            return this.deliveryBoyAddressStore.page;
        }
    },
    methods: {
        permissionChecker(e) {
        ...
        list: function (page = 1) {
            ...
            this.deliveryBoyAddressStore.fetch({
                id: this.props,
        ...
        edit: function (address) {
            ...
            this.loading.isActive = true;
            this.deliveryBoyAddressStore.edit(address.id).then((res) => {
                this.loading.isActive = false;
        ...
        destroy: function (addressId) {
            return new VueSimpleAlert.confirm(
                ...
                try {
                    this.loading.isActive = true;
                    this.deliveryBoyAddressStore.destroy({
                        id: this.props,
                        addressId: addressId,
                        search: this.address.search
                    }).then((res) => {
