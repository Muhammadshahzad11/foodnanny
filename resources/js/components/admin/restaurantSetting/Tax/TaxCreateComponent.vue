                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-on:keypress="floatNumber($event)" v-model="props.form.tax_rate" v-bind:class="errors.tax_rate ? 'invalid' : ''" type="text" id="tax_rate" class="db-field-control" />
...
export default {
    ...
    methods: {
        ...
        save: function () {
            try {
                const tempId = this.taxStore.temp.temp_id;
                this.loading.isActive = true;
                this.taxStore.save(this.props).then((res) => {
                    useModal().closeModal('modal');
                    this.loading.isActive = false;
                    alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.taxes"));
                    this.props.form = {
                        name: "",
                        code: "",
                        tax_rate: "",
