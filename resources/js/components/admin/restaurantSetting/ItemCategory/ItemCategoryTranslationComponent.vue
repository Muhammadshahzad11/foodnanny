<template>
    ...
    <ItemCategoryTranslationModalComponent :props="modalProps" />
</template>
...
import ItemCategoryTranslationModalComponent from "./ItemCategoryTranslationModalComponent.vue";

const KEYS = ["name", "description"];

export default {
    name: "ItemCategoryTranslationComponent",
    components: { LoadingComponent, ItemCategoryTranslationModalComponent },
    setup() {
        const itemCategoryStore = useItemCategoryStore();
        const languageStore = useLanguageStore();
        return { itemCategoryStore, languageStore };
    },
    data() {
        return {
    ...
    methods: {
        ...
        initForm: function () {
            const existing = this.itemCategory.translations || [];
            const translations = {};
