<template>
    ...
    <div id="itemCategoryTranslationModal" class="modal">
                    ...
                    <div class="form-row">
                        ...
                        <template v-if="props.selectedLanguage && props.form.translations[props.selectedLanguage]">
                            <div class="form-col-12">
                                ...
                                <p v-if="props.itemCategory.name" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5">
                                    <i class="lab lab-line-language"></i> {{ props.itemCategory.name }}
                                </p>
                            ...
                            <div class="form-col-12">
                                ...
                                <p v-if="props.itemCategory.description" class="text-xs text-paragraph bg-gray-50 rounded-md py-1.5 px-2.5 mb-1.5" v-html="props.itemCategory.description"></p>
...
export default {
    name: "ItemCategoryTranslationModalComponent",
    components: { LoadingComponent },
    props: ["props"],
    setup() {
        const itemCategoryStore = useItemCategoryStore();
        return { itemCategoryStore };
    },
    data() {
        return {
    ...
    methods: {
        close: function () {
            useModal().closeModal('itemCategoryTranslationModal');
        },
        save: function () {
            this.loading.isActive = true;
            this.itemCategoryStore.saveTranslations({ id: this.$props.props.id, form: this.$props.props.form }).then(res => {
                this.loading.isActive = false;
                useModal().closeModal('itemCategoryTranslationModal');
                alertService.success(res.data.message);
                this.itemCategoryStore.view(this.$props.props.id);
            }).catch(err => {
                this.loading.isActive = false;
