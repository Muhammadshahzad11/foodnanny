@echo off
title Kill buildwithnexclass Print Agents
echo Closing all buildwithnexclass / Print Agent PowerShell processes...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "Get-Process powershell,pwsh -EA SilentlyContinue | Where-Object { $_.MainWindowTitle -match 'Print Agent|buildwithnexclass|Local Print' } | Stop-Process -Force;" ^
