...
class PaymentGatewayTableSeederVersionOne extends Seeder
{
    ...
    public function run(): void
    {
        foreach ($this->gateways as $gateway) {
            ...
            if(file_exists(public_path('/images/seeder/payment-gateway/' . $gateway['slug'] . '.png'))) {
                $payment->addMedia(public_path('/images/seeder/payment-gateway/' . $gateway['slug'] . '.png'))->preservingOriginal()->toMediaCollection('payment-gateway');
            }
        }
    }
