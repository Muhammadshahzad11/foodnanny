...
class ItemAttributeService
{
    ...
    public object $itemAttribute;
    protected array $itemAttributeFilter = [
        'name',
        'status'
    ];
     ...
     * @throws Exception
     */
    public function store(ItemAttributeRequest $request): object
    {
        try {
     ...
     * @throws Exception
     */
    public function destroy(ItemAttribute $itemAttribute): void
    {
        try {
