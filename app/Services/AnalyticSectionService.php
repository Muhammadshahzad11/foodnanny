...
class AnalyticSectionService
{
     ...
     * @throws Exception
     */
    public function update(AnalyticSectionRequest $request, Analytic $analytic, AnalyticSection $analyticSection): AnalyticSection
    {
        try {
            if (!$this->envService->getValue('DEMO')) {
     ...
     * @throws Exception
     */
    public function destroy(Analytic $analytic, AnalyticSection $analyticSection): void
    {
        try {
