...
class AiChatHistoryService
{
    ...
    {
        try {
            return AiChatHistory::where(['restaurant_id' => $restaurant->id, 'user_id' => Auth::user()->id, 'ai_agent_id' => Settings::group('site')->get('site_default_ai_agent')])->orderBy('id', 'asc')->get();
     ...
     * @throws Exception
     */
    public function store(AiRequest $aiRequest, Restaurant $restaurant)
    {
        try {
