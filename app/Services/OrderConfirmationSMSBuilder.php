...
class OrderConfirmationSMSBuilder
{
    public int $orderId;
    public mixed $status;
    public object $order;
    ...
    private function pending($name, $code, $phone, $orderId): void
    {
        ...
        if ($notificationAlert && $notificationAlert->sms == SwitchBox::ON) {
            $this->sms($code, $phone, trans('all.message.order_sms_message', [
                'name'    => $name,
                'orderId' => $orderId,
    ...
    private function preparing($name, $code, $phone, $orderId): void
    {
    ...
    private function prepared($name, $code, $phone, $orderId): void
    {
    ...
    private function outForDelivery($name, $code, $phone, $orderId): void
    {
    ...
    private function returned($name, $code, $phone, $orderId): void
    {
