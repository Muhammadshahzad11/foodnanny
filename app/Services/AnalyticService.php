...
class AnalyticService
{
    ...
    protected array $analyticsFilter = [
        'name',
        'status'
    ];
    ...
    public function store(AnalyticRequest $request)
    {
        try {
            if (!$this->envService->getValue('DEMO')) {
                return Analytic::create($request->validated());
            } else {
     ...
     * @throws Exception
     */
    public function update(AnalyticRequest $request, Analytic $analytic): Analytic
    {
        try {
            if (!$this->envService->getValue('DEMO')) {
     ...
     * @throws Exception
     */
    public function destroy(Analytic $analytic): void
    {
        try {
