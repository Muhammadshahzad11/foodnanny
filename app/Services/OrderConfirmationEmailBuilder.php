...
class OrderConfirmationEmailBuilder
{
    ...
    {
        try {
            Mail::to($email)->send(new OrderConfirmation($name, $orderId, $message));
        } catch (Exception $e) {
    ...
    private function confirmation($name, $email, $orderId): void
    {
    ...
    private function preparing($name, $email, $orderId): void
    {
    ...
    private function prepared($name, $email, $orderId): void
    {
    ...
    private function outForDelivery($name, $email, $orderId): void
    {
    ...
    private function returned($name, $email, $orderId): void
    {
