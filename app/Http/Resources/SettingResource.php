...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'demo_customer_phone'                       => \App\Support\DemoCustomerLogin::phoneDigits(),
            'demo_customer_country_code'                => \App\Support\DemoCustomerLogin::COUNTRY_CODE,
            'demo_customer_skip_otp'                    => true,
