...
class OrderItemResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'item_variation_total'             => AppLibrary::convertAmountFormat($this->item_variation_total),
            'item_extra_total'                 => AppLibrary::convertAmountFormat($this->item_extra_total),
            'tax_amount'                       => AppLibrary::convertAmountFormat($this->tax_amount),
            ...
            'tax_type_value'                   => (int) $this->tax_type,
