...
class AnalyticSectionController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:system_settings', only: ['index', 'show', 'store', 'update', 'destroy'])
        ];
    }
