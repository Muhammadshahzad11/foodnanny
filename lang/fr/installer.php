...
return [
    ...
    'installed'   => [
        'success_log_message' => 'Foodnanny installer successfully INSTALLED on ',
        'update_log_message'  => 'Foodnanny Installer successfully UPDATED on ',
    ]
];
